...
import { CreateOrEditDemoModelModalComponent } from './demoModels/create-or-edit-demoModel-modal.component';
...
@NgModule({
    ...
    declarations: [
        ...
        DemoModelsComponent, CreateOrEditDemoModelModalComponent,
        CarComponent, CarAddComponent
    ],
    providers: [
